...
`lib/data.ts` に単語(`vocabList`、55語)と文法問題(`grammarList`、55問)が入っています。
今回は「中学3年生レベルでよく扱う内容」を想定した**仮のサンプル**です(受け身・現在完了・不定詞の応用・関係代名詞・分詞の後置修飾・間接疑問文・使役動詞など)。
